""" File modified from orignial source file https://github.com/raghakot/keras-resnet/blob/master/resnet.py """
...
def basic_block(filters, init_strides=(1, 1), is_first_block_of_first_layer=False):
    ...
    def f(input):
        ...
        if is_first_block_of_first_layer:
            ...
            # sebotic: original kernel size 3,3
...
#        model = Model(inputs=[input_conv, input, input_tstv], outputs=dense)
